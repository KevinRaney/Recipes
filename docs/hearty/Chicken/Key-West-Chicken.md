...
2. Preheat an indoor or outdoor grill for high heat.
3. Spray pam on the grill grate. Discard marinade and grill chicken for 6 to 8 minutes on each side until juices run clear.

![Key West Chicken](./Key-West-Chicken.png)
