...
2. Heat olive oil spray in a large nonstick skillet set over medium-high heat. Add the chicken and cook for 2 minutes on each side. Transfer the chicken to a plate.
...
4. Boil chicken broth add cauli rice
5. Transfer the chicken to a plate. Serve with the cauli rice.

![One-Pot Chicken & Mushroom Cauliflower Rice](./One-Pot-Chicken-Mushroom-Cauliflower-Rice.png)
